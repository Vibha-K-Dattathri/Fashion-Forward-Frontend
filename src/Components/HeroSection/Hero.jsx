  ...
  return (
    <div className="hero-section">
      <div className="hero-content">
        <h2>We're here to assist with your everyday style dilemmas</h2>
        <p>
          Wondering which clothes complement your appearance? Struggling to pair your items
          into trendy outfits? Unsure about buying a specific item? Need wardrobe updates or
          personalized clothing suggestions? Just ask your AI Stylist!
        </p>
